    ...
    <section className="min-h-[100dvh] w-full snap-start snap-always flex flex-col items-center justify-center p-6 lg:p-12 bg-transparent relative overflow-hidden z-0">
      ...
      <div className="max-w-5xl w-full mx-auto flex flex-col gap-12 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {featuredProjects.map((proj, idx) => (
            <motion.div
              ...
              className="group bg-mantle/90 backdrop-blur-md border border-surface0 hover:border-surface2 transition-all duration-500 p-8 rounded-3xl flex flex-col gap-6 relative overflow-hidden shadow-2xl"
            >
               ...
               <div className="w-12 h-12 rounded-xl bg-surface0/90 backdrop-blur-md border border-surface1 flex items-center justify-center relative z-10 transition-transform group-hover:scale-110 shadow-md">
                  {proj.icon}
               </div>
        ...
        >
          <Link
            href="/projects"
            className="px-10 py-5 bg-mantle/90 backdrop-blur-md border-2 border-dashed border-surface1 hover:border-surface2 hover:bg-surface0 transition-all duration-300 rounded-3xl flex items-center gap-4 group shadow-xl"
          >
             ...
             <div className="w-12 h-12 rounded-full bg-surface0/90 backdrop-blur-md flex items-center justify-center group-hover:bg-text group-hover:text-base transition-all transform group-hover:translate-x-2 shadow-md">
