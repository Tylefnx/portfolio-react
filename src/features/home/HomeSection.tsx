    ...
    <section className="min-h-[100dvh] w-full snap-start snap-always flex flex-col items-center justify-center p-6 lg:p-12 relative overflow-hidden bg-transparent z-0">
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        >
          ...
          <h1 className="text-4xl lg:text-7xl font-black leading-tight tracking-tighter whitespace-pre-line">
        ...
        >
          <Link href="/terminal" className="block outline-none">
            <div className="bg-mantle/40 backdrop-blur-xl rounded-[2rem] border border-surface0 p-8 lg:p-12 relative overflow-hidden group hover:border-blue/50 transition-all duration-500 cursor-pointer shadow-2xl">
              ...
              <div className="flex flex-col gap-8 relative z-10">
                <div className="w-16 h-16 rounded-2xl bg-surface0/40 backdrop-blur-md border border-surface1 flex items-center justify-center group-hover:bg-blue/10 transition-colors duration-500 shadow-lg">
