...
export default function ContactSection() {
  ...
  return (
    <section className="min-h-[100dvh] w-full snap-start snap-end flex flex-col pt-28 pb-16 lg:pt-32 lg:pb-24 p-6 lg:p-12 bg-transparent relative overflow-hidden z-0">
      <motion.div 
