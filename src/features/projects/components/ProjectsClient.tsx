    ...
    <>
      ...
      <main ref={containerRef} className="h-[100dvh] w-full overflow-y-scroll snap-y snap-mandatory bg-transparent custom-scrollbar relative">
        {projects.map((proj, index) => (
          <section
            key={proj.id}
            className="min-h-[100dvh] w-full snap-start snap-always flex flex-col items-center justify-center pt-32 pb-20 lg:pt-40 lg:pb-32 relative overflow-hidden bg-transparent border-b border-surface0 last:border-b-0 z-0"
          >
