      ...
      {projects.map((proj, index) => (
        ...
        >
          ...
          <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center z-10">
            ...
            >
              <div className="w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg bg-white/10 border border-white/10 text-white transition-transform duration-500 hover:scale-110">
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                 ...
                 {["Next.js", "TypeScript", "Tailwind"].map(tag => (
                   <span key={tag} className="px-3 py-1 bg-white/5 backdrop-blur-md rounded-lg text-xs font-mono text-text/90 border border-white/10 shadow-sm">
                      {tag}
                   </span>
                 ))}
              </div>
              ...
              <div className="flex items-center gap-4 mt-8">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-8 py-3.5 bg-text text-base hover:scale-105 transition-all duration-300 rounded-2xl font-bold flex items-center gap-2 shadow-[0_0_20px_rgba(205,214,244,0.1)] hover:shadow-[0_0_25px_rgba(205,214,244,0.3)]"
                >
            ...
            >
               <div className="aspect-video bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 shadow-2xl flex items-center justify-center relative overflow-hidden group">
                  <div className="absolute inset-0 bg-white/5 group-hover:bg-white/10 transition-colors duration-500" />
                  <span className="text-text/70 font-bold tracking-widest uppercase italic group-hover:scale-110 transition-transform duration-500">
                     [ {proj.id} preview ]
                  </span>
