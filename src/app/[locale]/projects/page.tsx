      ...
      {projects.map((proj, index) => (
        ...
        >
          ...
          <div className="max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center z-10">
            ...
            >
              <div className={`w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg border-2 ${projectColors[proj.id as keyof typeof projectColors]} bg-surface0 transition-transform duration-500 hover:scale-110`}>
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                 ...
                 {["Next.js", "TypeScript", "Tailwind"].map(tag => (
                   <span key={tag} className="px-3 py-1 bg-surface0 rounded-lg text-xs font-mono text-subtext1 border border-surface1 shadow-sm">
                      {tag}
                   </span>
                 ))}
              </div>
